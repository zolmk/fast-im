...
create table unread_msg (
    id bigint(64) not null auto_increment       comment '未读消息ID',
    receiver bigint(64) not null unique         comment '接收人',
    count int default 0                         comment '未读消息数量',
    since timestamp default NOW()               comment '记录第一条未读消息的时间戳',
    flags int                                   comment '',
    msg_id bigint(64) not null                  comment '消息ID',
